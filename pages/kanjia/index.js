...
Page({
  ...
  getKanjiaInfo: function (kjid, joiner) {
    var that = this;
    wx.request({
      url: 'https://api.spzwl.com/' + app.globalData.subDomain + '/shop/goods/kanjia/info',
      data: {
        kjid: kjid,
        joiner: joiner,
      },
  ...
  getKanjiaInfoMyHelp: function (kjid, joiner) {
    var that = this;
    wx.request({
      url: 'https://api.spzwl.com/' + app.globalData.subDomain + '/shop/goods/kanjia/myHelp',
      data: {
        kjid: kjid,
        joinerUser: joiner,
  ...
  helpKanjia: function () {
    var that = this;
    wx.request({
      url: 'https://api.spzwl.com/' + app.globalData.subDomain + '/shop/goods/kanjia/help',
      data: {
        kjid: that.data.kjId,
